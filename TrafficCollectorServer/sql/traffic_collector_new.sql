...
--
DROP DATABASE IF EXISTS `traffic_collector_new`;
CREATE DATABASE IF NOT EXISTS `traffic_collector_new` DEFAULT CHARACTER SET latin1 COLLATE latin1_swedish_ci;
USE `traffic_collector_new`;
