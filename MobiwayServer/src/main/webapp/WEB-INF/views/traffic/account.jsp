...
<html xmlns="http://www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <div id="page-top-outer" style="height: 105px;">
            ...
            <div id="page-top">
                ...
                <div id="logo" style="margin-top: 5px;">
                    <a href=""><img src="images/shared/mobiway.png" height="100" alt="" /></a>
                </div>
                <!-- end logo -->
        ...
        <div id="footer">
            <!--  start footer-left -->
            <div id="footer-left">
                Mobiway &copy; Copyright Politehnica University of Bucharest. <span id="spanYear">2012</span> <a href="http://mobiway.hpc.pub.ro">http://mobiway.hpc.pub.ro</a>. All rights reserved.</div>
            <!--  end footer-left -->
            <div class="clear">&nbsp;</div>
        </div>
        <!-- end footer -->
